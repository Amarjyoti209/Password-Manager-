...
const Manager = () => {
  ...
  const savePass = () => {
    ...
    localStorage.setItem(
      "passwords",
      JSON.stringify([...passAry, { ...form, id: uuid() }])
    );
  ...
  return (
    <>
      ...
      <div className="main min-h-[89vh] flex justify-center items-center text-white">
        ...
        <div className="box min-h-[60vh] bg-gray-800 w-[95vw] p-3 py-2 flex flex-col gap-5 mobile rounded-3xl">
          {/* Logo */}
          ...
          <button
            onClick={savePass}
            className="flex justify-center items-center gap-1 w-fit mx-auto bg-blue-500 px-5 rounded-full hover:bg-blue-500"
          >
            <lord-icon
          ...
          {passAry.length != 0 && (
            <div>
              ...
              <table className="table-auto w-full text-center rounded-md overflow-hidden">
                <thead>
                  <tr className="bg-blue-500 text-md">
                      ...
                      <tr key={index}>
                        <td>
                          <div
                            ...
                            className="flex items-center gap-1 justify-center cursor-pointer my-1"
                          >
                          ...
                          <div className="flex items-center gap-2 justify-center cursor-pointer">
                            ...
                            >
                              <lord-icon
                                ...
                                trigger="hover"
                                colors="primary:#121131,secondary:#ffc738,tertiary:#ebe6ef,quaternary:#f9c9c0,quinary:#d1f3fa"
